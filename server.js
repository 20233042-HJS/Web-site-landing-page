...
//  DB 연결 (교수용 / 학생용 분리)
// ──────────────────────────────────────────
const professorDB = mongoose.createConnection('mongodb://127.0.0.1:27017/professor_db');
const studentDB   = mongoose.createConnection('mongodb://127.0.0.1:27017/student_db');
